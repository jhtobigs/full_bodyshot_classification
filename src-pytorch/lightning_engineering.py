...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--path",
        type=str,
        default="D:/data/musinsa/train_test_valid",
        help="parent directory containing train, val, test data",
    )
    ...
    parser.add_argument(
        "--num_classes", type=int, default=2, help="output class number"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="mobilenet",
        help="resnet/mobilenet/efficientnet/rexnet",
    )
    parser.add_argument(
        "--pretrain", type=str, default="true", help="using ImageNet-pretrained Model"
    )
    parser.add_argument(
        "--mult", type=float, default=1.0, help="rexnet scale(1.0/1.3/1.5/2.0)"
    )
